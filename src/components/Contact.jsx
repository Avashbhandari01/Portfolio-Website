...
const Contact = () => {
  return (
    <div
      id="contact"
      className="h-screen py-20 px-96 lg:px-20 md:px-10 lg:place-items-center sm:place-items-center"
    >
      <Heading text="Get in touch" />
      <div className="w-full h-full my-auto flex lg:flex-col items-center justify-between lg:justify-center gap-x-20">
        <motion.div
        ...
        >
          <Image
            ...
            width={400}
            height={400}
            className="w-[400px] rounded-md opacity-80 lg:hidden  min-w-[100px]"
          />
        </motion.div>
        <motion.form
          ...
          transition={{ duration: 0.4 }}
          viewport={{ once: true }}
          className="w-[600px] lg:w-[400px] flex flex-col gap-3 sm:w-[250px]"
        >
